...
useEffect(() => {
  const resetState = () => {
    ...
    setStatus('Let\'s Say Something'); // Reset status message
  };
            ...
            <div className="text w-8/12 mx-auto">
              ...
              >
                <button
                  ...
                  className={`w-36 h-36 rounded-full flex items-center justify-center transition-transform duration-300 relative ${isRecording ? 'bg-sky-950 shadow-lg scale-110' : 'bg-blue-500'
                    }`}
                >
                  <div className="absolute inset-0 bg-indigo-900 rounded-full h-[100px] w-[100px] z-[1] flex justify-center items-center m-auto top-0 left-0 right-0">
                    <svg
                      width="58"
                      height="58"
                      viewBox="0 0 58 58"
  ...
  <div className={keywords.length > 0 ? '' : 'hidden'}>
    <h3 className="text-xl font-semibold text-white mb-4">Extracted Keywords:</h3>
